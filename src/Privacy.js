...
function Privacy() {
    return (
        <div className="privacy">
            ...
            <h2>Last updated April 29, 2022</h2>

            <p>This privacy notice for Bright Desings ("Company," "we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:</p>

            <ul>
                <li>Download and use our mobile application (Expenditure Buddy), or any other application of ours that links to this privacy notice</li>
                <li>Engage with us in other related ways, including any sales, marketing, or events</li>
            </ul>

            <p><strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:lebrightdesings@gmail.com">lebrightdesings@gmail.com</a>.</p>
            ...
            <p>We collect personal information that you voluntarily provide to us when you express an interest in obtaining information about us, our products, or our services, or when you participate in activities on the Services, or otherwise when you contact us.</p>

            <p><strong>Sensitive Information.</strong> We do not process sensitive information.</p>

            <p><strong>Payment Data.</strong> We may collect data necessary to process your payment, such as your credit card number and the associated security code. All payment data is stored by Google Pay. <a href="https://payments.google.com/payments/apis-secure/u/0/get_legal_document?ldo=0&ldt=privacynotice&ldl=en-GB">Click here</a> for their privacy notice.</p>

            <p><strong>Application Data.</strong> If you use our application(s), we may collect information such as:</p>
            <ul>
                <li><strong>Mobile Device Access:</strong> We may request access to certain features from your mobile device, such as your storage.</li>
                <li><strong>Mobile Device Data:</strong> We collect device information (e.g., mobile device ID, model, operating system, etc.) to maintain security and troubleshoot.</li>
            </ul>

            <h3>2. HOW DO WE PROCESS YOUR INFORMATION?</h3>
            <p>We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with the law. We may also process your information with your consent for other purposes.</p>

            <h3>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</h3>
            <p>If you are located in the EU or UK, we rely on the following legal bases:</p>
            <ul>
                <li><strong>Consent:</strong> We process your information if you give us consent for a specific purpose.</li>
                <li><strong>Legal Obligations:</strong> We process your information to comply with laws.</li>
                <li><strong>Vital Interests:</strong> We process your information to protect vital interests.</li>
            </ul>

            <h3>4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h3>
            <p>We may share information in specific situations, such as during business transfers or with service providers.</p>

            <h3>5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h3>
            <p>We are not responsible for the safety of any information that you share with third parties. Our Services may contain links to third-party websites or services that are not affiliated with us.</p>
            ...
            <p>If you have questions or comments about your privacy rights, you may email us at lebrightdesigns@gmail.com.</p>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>A. Identifiers</td>
                        <td>Details such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name</td>
                        <td>NO</td>
                    </tr>
                    <tr>
            ...
            <p>You may contact us by email at <a href="mailto:lebrightdesigns@gmail.com">lebrightdesigns@gmail.com</a>, or by referring to the contact details at the bottom of this document.</p>
            ...
            <p>Bright Designs has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. Bright Designs will not sell personal information in the future belonging to website visitors, users, and other consumers.</p>

            <h3>Your rights with respect to your personal data</h3>
            <ul>
                <li><strong>Right to request deletion of the data – Request to delete</strong>: You can ask for the deletion of your personal information. If you ask us to delete your personal information, we will respect your request and delete your personal information, subject to certain exceptions provided by law, such as (but not limited to) the exercise by another consumer of his or her right to free speech, our compliance requirements resulting from a legal obligation, or any processing that may be required to protect against illegal activities.</li>
                <li><strong>Right to be informed – Request to know</strong>: Depending on the circumstances, you have a right to know:
                    <ul>
            ...
            <p>If you have questions or comments about this notice, you may email us at <a href="mailto:lebrightdesigns@gmail.com">lebrightdesigns@gmail.com</a> or by post to:</p>
            <p>Bright Designs<br></br>8666<br></br>8990<br></br>Nairobi, Kenya 00100<br></br>Kenya</p>

            <h2>12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
            <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please visit: __________.</p>

            <p>This privacy policy was created using Termly's Privacy</p>
